...
import guessNumber from '../../assets/images/guessNumber.png';
import './styles.scss';
        ...
        return(
            <React.Fragment>
                <div id={`tiles`} className={`tiles`}>
                    ...
                    <div className={`tile`}>
                        <h3 className={`heading-secondary`}><span className='highlight'>Guess My Number!</span></h3>
                        <div className={`project__display`}>
                            <div className={`project__display__poster`}>
                                <a href={`https://david-sanvicente.github.io/DOM_practice_guess_the_number/`}>
                                    <img src={guessNumber} alt={`Project Thumbnail`} />
                                </a>
                            </div>
                            <div className={`project__display__actions`}>
                                <a href={`https://david-sanvicente.github.io/DOM_practice_guess_the_number/`} className={`link`}><i className="fas fa-desktop"></i><span className="highlight">View Demo</span></a>
                                {/* <a href={`#`} className={`link link--inactive`}><i className="fas fa-code-branch"></i><span>Source Private</span></a> */}
                                <a href={`https://github.com/david-sanvicente/DOM_practice_guess_the_number`} className={`link`}><i className="fas fa-code-branch"></i><span className="highlight">View Source</span></a>
                            </div>
                            <p className={'aside'}>Another fun game written in <span className={`highlight`}>JavaScript</span>. The game has win and loss <span className={`highlight`}>conditions</span> that update the game's messaging and colors. Demonstrates <span className={`highlight`}>DOM manupulation</span> and <span className={`highlight`}>event handlers</span>.</p>
                        </div>
                        <div className={`project__technologies`}>
                            <ul className={`project__technologies__list`}>
                                <li><i className="fas fa-dot-circle"></i><p>HTML</p></li>
